# -*- coding: utf-8 -*-
"""
agentframework.py created on Fri Mar  8 19:42:49 2019

@author: Danielle Sinnett, student number 200827672

This is the agent class needed to run the final agent based model and
versions 4 and 5.

To ensure the agent based model runs correctly please ensure that this file is
saved in the same folder as the model.py.
